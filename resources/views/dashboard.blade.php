...
<body class="sidebar-layout">
        ...
        <div class="container">
            ...
            <header class="dashboard-header">
                <div class="welcome-section">
                    ...
                    <h1 class="welcome-text">Halo, {{ auth()->user()->name }}! 👋</h1>
                </div>
            </header>
            ...
            <div class="content-wrapper">
                ...
                <div class="impact-card">
                    <div class="impact-header">
                        ...
                        <p class="impact-date">{{ now()->format('F Y') }}</p>
                    </div>
                ...
                <section class="quick-actions">
                    ...
                    <div class="actions-grid">
                        {{-- ✅ Ganti href jadi Laravel route --}}
                        <a href="{{ url('/dropbin') }}" class="action-card green" style="text-decoration: none; color: inherit;">
                        ...
                        <a href="{{ url('/marketplace') }}" class="action-card blue" style="text-decoration: none; color: inherit;">
                            <div class="action-icon">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    {{-- ✅ Load JS pake Laravel asset helper --}}
